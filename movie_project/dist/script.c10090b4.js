...
//TMDB
var API_KEY = 'api_key=610706d1bdc74e762f2163414724355c';
...
function showMovies(data) {
  main.innerHTML = '';
  data.forEach(function (content__movie) {
    var title = content__movie.title,
        poster_path = content__movie.poster_path,
        overview = content__movie.overview;
    var movieEl = document.createElement('div');
    movieEl.classList.add('content__movie');
    movieEl.innerHTML = "\n            \n            <img src=\"".concat(IMG_URL + poster_path, "\" alt=\"").concat(title, "\">\n            \n            <div class=\"content__movie__data\">\n                <h3 class=content__movie__data__head>").concat(title, "</h3>\n                <p class=\"content__movie__data__text\">").concat(overview, "</p>\n                <button class=\"content__movie__data__watch\">Watch Now</button>\n            </div>\n        ");
